        ...
        <div class=" content col-sm-9">
            ...
            <div class="grid-list-wrapper">   
                <div class="product-layout product-list col-xs-12">
                    <div class="product-thumb">
                        <div class="image product-imageblock">
                            <a href="./PDF/SEGUIN/ALTERNATIVOS/OENOFIRST.pdf" target="_blank">
                        ...
                        <div class="caption product-detail">
                            <h4 class="product-name">
                                <a href="#" title="Oenofirst R00-R01 ">Oenofirst R00-R01 </a>
                            </h4>
                        </div>
                    </div>
                </div>
                <div class="product-layout product-list col-xs-12">
                    <div class="product-thumb">
                        <div class="image product-imageblock">
                            <a href="./PDF/SEGUIN/ALTERNATIVOS/OENOFIRST_ROSE.pdf" target="_blank">

                                <img src="image/products/oeno-rose.jpg" class="img-responsive" />
                                <img src="image/products/oeno-rose.jpg" class="img-responsive" />
                            </a>
                            <ul class="button-group grid-btn">
                        ...
                        <div class="caption product-detail">
                            <h4 class="product-name">
                                <a href="#" title="Oenofirst Rosé ">Oenofirst Rosé </a>
                            </h4>
                        </div>
                    </div>
                </div>
